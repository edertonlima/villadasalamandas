...
function change_post_label() {
    ...
    global $submenu;
    $menu[5][0] = 'Casas';
    $submenu['edit.php'][5][0] = 'Todas as casas';
    $submenu['edit.php'][10][0] = 'Adicionar nova casa';
    echo '';
}
function change_post_object() {
    ...
    $labels->name = 'Casas';
    $labels->singular_name = 'Casas';
    $labels->add_new = 'Adicionar nova casa';
    $labels->add_new_item = 'Adicionar nova casa';
    $labels->edit_item = 'Editar casa';
    $labels->new_item = 'Casa';
    $labels->view_item = 'Ver casa';
    $labels->search_items = 'Buscar casas';
    $labels->not_found = 'Nenhuma casa encontrada';
    $labels->not_found_in_trash = 'Nenhuma casa encontrada na lixeira';
    $labels->all_items = 'Todas as casas';
    $labels->menu_name = 'Casa';
    $labels->name_admin_bar = 'Casa';
    $labels->name_admin_bar = 'Casa';
}
